...
class Contracts(models.Model):
    ...
    contract_id = models.BigIntegerField(primary_key=False)
...
class Customers(models.Model):
    ...
    customer_id = models.CharField(max_length=50, primary_key=False)
...
class InternetServices(models.Model):
    internet_id = models.BigIntegerField(primary_key=False)
    customer_id = models.TextField()
...
class PaymentMethods(models.Model):
    payment_id = models.BigIntegerField(primary_key=False)
...
class PhoneServices(models.Model):
    phone_id = models.BigIntegerField(primary_key=False)
    customer_id = models.TextField()
...
class ChurnRecords(models.Model):
    churn_id = models.BigIntegerField(primary_key=False)
    customer_id = models.TextField()
